...
Details
-------
The `mrg32k3a <https://mrg32k3a.readthedocs.io/en/latest/mrg32k3a>`_ module includes the ``MRG32k3a`` class and several useful functions for controlling the generators.
